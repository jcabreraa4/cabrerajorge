...
function MenubarTrigger({ className, ...props }: React.ComponentProps<typeof DropdownMenuTrigger>) {
  return (
    <DropdownMenuTrigger
      ...
      className={cn('flex items-center rounded-none px-1.5 py-[calc(--spacing(0.8))] text-xs font-medium outline-hidden select-none hover:bg-muted aria-expanded:bg-muted', className)}
      {...props}
    />
  );
}
...
function MenubarCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn('relative flex cursor-default items-center gap-2 rounded-none py-2 pr-28 pl-8 text-xs outline-hidden select-none focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground data-inset:pl-8 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0', className)}
      checked={checked}
      {...props}
    >
...
function MenubarSubTrigger({
  ...
  return (
    <DropdownMenuSubTrigger
      ...
      data-inset={inset}
      className={cn("gap-2 rounded-none px-2 py-2 text-xs focus:bg-accent focus:text-accent-foreground data-inset:pl-8 data-open:bg-accent data-open:text-accent-foreground [&_svg:not([class*='size-'])]:size-4", className)}
      {...props}
    />
  );
}
