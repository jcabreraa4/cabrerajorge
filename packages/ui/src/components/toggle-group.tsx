...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive.Root
      ...
      className={cn('group/toggle-group flex w-fit flex-row items-center gap-[--spacing(var(--gap))] data-[spacing=0]:data-[variant=outline]:rounded-none data-vertical:flex-col data-vertical:items-stretch', className)}
      {...props}
    >
